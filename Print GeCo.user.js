...
(function() {
    ...
    window.Stampa = function () {
        ...
        a.document.write('document.querySelector("#result_list > thead > tr > th.sortable.column-tipo_misuratore").style.display = "none";');
        ...
        a.document.write('document.querySelector("#result_list > thead > tr > th.sortable.column-codice_ante_sostituzione").style.display = "none";');
        a.document.write('document.querySelector("#result_list > thead > tr > th.sortable.column-matricola_ante_sostituzione").style.display = "none";');
        a.document.write('document.querySelector("#result_list > thead > tr > th.sortable.column-pod").style.display = "none";');
        ...
        a.document.write('document.querySelector("#result_list > tbody > tr:nth-child(" + i + ") > td.field-tipo_misuratore").style.display = "none";');
        ...
        a.document.write('document.querySelector("#result_list > tbody > tr:nth-child(" + i + ") > td.field-codice_ante_sostituzione").style.display = "none";');
        a.document.write('document.querySelector("#result_list > tbody > tr:nth-child(" + i + ") > td.field-matricola_ante_sostituzione").style.display = "none";');
        a.document.write('document.querySelector("#result_list > tbody > tr:nth-child(" + i + ") > td.field-pod").style.display = "none";');
